"plot.db" <- function(x,makepic="FALSE",ext="png",seetrees="FALSE",numplot=4,type="unrooted",linewidth=1,colors=NULL,ppt=0) {
if(ext!="png"&ext!="pdf"){
...
if(seetrees=="TRUE"){for(i in 1:miny2){plot.phylo(trees[[columns[i]]],edge.width=3,edge.col=i,cex=1,type=type)}}
dev.off()
}
