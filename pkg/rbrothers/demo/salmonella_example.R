...
my.fimH.align = read.dna(file=system.file("extdata/fimH/Salmonella_fimH8.phy",package="rbrothers"))
...
plot(fimH.db,seetrees="TRUE",ppt=0.5)
plotmcmc(fimH.db)
summary(fimH.db)
...
my.fimA.align = read.dna(file=system.file("extdata/fimH/Salmonella_fimA8.phy",package="rbrothers"))
...
plot(fimA.db,seetrees="TRUE",ppt=0.5)
plotmcmc(fimA.db)
summary(fimA.db)
